...
if (summ >= 8 ) alert ('Молодец, ты знаток географии');
else alert('подучи географию')



// if (summ ==10) alert ("все верно");

// else if ( 6 <= sum <=9 ) alert ("почти молодец!");

// else if (5 <= sum <=4) alert ("подучи географию!");

// else alett ("покупай карту");
